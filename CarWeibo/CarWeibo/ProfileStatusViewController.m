...
- (void)viewDidLoad
{
    ...
    userTimelineController = [[UserTimelineController alloc] initWithNavController:[self navigationController] User:user];
    [userTimelineController.tableView setFrame:CGRectMake(0, 6, 320, 460-6)];
    //    [friendsTimelineController.tableView setTableHeaderView:tableHeaderView];
    [userTimelineController.tableView setBackgroundColor:[UIColor clearColor]];
    [self.view addSubview:userTimelineController.view];
}
